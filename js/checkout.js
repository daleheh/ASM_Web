...
function xulyDathang(product) {
    ...
    if(tudenlay.classList.contains("active")){
        ...
        if(chinhanh1.checked) {
            diachinhan = "So 3 Trinh Van Bo, Xuan Phuong, Nam Tu Liem, Ha Noi";
       }
    ...
    if(tennguoinhan == "" || sdtnhan == "" || diachinhan == "") {
        toast({ title: 'Attention', message: 'Please enter complete information!', type: 'warning', duration: 4000 });
    } else {
        let donhang = {
            id: madon,
        ...
        toast({ title: 'Successfully', message: 'Order successful !', type: 'success', duration: 1000 });
        setTimeout((e)=>{
            window.location = "/";
        },2000);  
    }
